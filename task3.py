...
letter_value = {'a': 1, 'b': 3, 'c': 3, 'd': 2, 'e': 1, 'f': 4, 'g': 2, 'h': 4, 'i': 1, 'j': 8, 'k': 5,
            'r': 1, 's': 1, 't': 1, 'q': 10, 'v': 4, 'w': 4, 'x': 8, 'y': 4, 'z': 10, 'u': 1, 'o': 1,
             'm': 3, 'p': 3, 'l': 1, 'n': 1, 'а': 1, 'в': 1, 'е': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1,
...
for i in range(len(process_word)):
    res += letter_value[process_word[i]]
